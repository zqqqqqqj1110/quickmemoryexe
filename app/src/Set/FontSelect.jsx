...
const FontSelect = () => {
  ...
  const handleFileChange = (event) => {
    ...
    setSelectedFont(file); // 传递整个文件对象而不是文件名
  };
  ...
  const handleConfirm = () => {
    if (selectedFont) {
      // 在这里处理选择字体后的逻辑
      console.log("选择的字体：", selectedFont.name);
    }
  };
  ...
  return (
    <div>
      ...
      <div>
        ...
        <select id="selectFont" value={selectedFont.name} onChange={(e) => setSelectedFont(e.target.value)}>
